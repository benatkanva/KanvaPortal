...
```ts
import { useCreateNewGoal, useGetMyGoals, useUpdateGoal, useDeleteGoal } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useUpdateGoal(updateGoalVars);
...
```js
import { createNewGoal, getMyGoals, updateGoal, deleteGoal } from '@dataconnect/generated';
