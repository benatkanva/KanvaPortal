...
export default function CreateNewGoalComponent() {
  ...
  mutation.mutate({ name: ..., description: ..., targetValue: ..., deadline: ..., type: ..., status: ..., });
...
export default function UpdateGoalComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ id: ..., name: ..., description: ..., targetValue: ..., deadline: ..., type: ..., status: ..., priority: ..., category: ..., });
